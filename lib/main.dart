                ...
                children: [
                        ...
                        child: SingleChildScrollView(
                            child: FutureBuilder<List<Widget>>(
                                ...
                                builder: (
                                  ...
                                  if (snapshot.connectionState == ConnectionState.waiting) return Container(child: CircularProgressIndicator(size: 20, color: Colors.white));
                                  return Text("");
                                }))),
                  ),
                  ...
                  AnimatedPositioned(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.only(left: Config.PADDING_DEFAULT, right: Config.PADDING_DEFAULT, top: 30),
