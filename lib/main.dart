                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            //Password
                            Padding(padding: EdgeInsets.symmetric(vertical: 20), child: SizedBox(width: 130, child: TextField(obscureText: true, autocorrect: false, textAlign: TextAlign.center, style: TextStyle(color: Colors.white), decoration: InputDecoration(border: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0), borderSide: BorderSide(color: Config.COLOR_DARKGRAY)), fillColor: Config.COLOR_DARKGRAY, filled: true)))),
