...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  bool validatePassword() {
    ...
    log.debug("User password is " + md5(password));
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            //Password
                            _lockedScreen ? Padding(padding: EdgeInsets.symmetric(vertical: 20), child: SizedBox(width: 130, child: TextField(maxLength: 4, obscureText: true, autocorrect: false, textAlign: TextAlign.center, style: TextStyle(color: Config.COLOR_DARKGRAY, letterSpacing: 14), decoration: InputDecoration(/*hintText: "****", hintStyle: TextStyle(color: Colors.white),*/ counterText: "" /*, enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0), borderSide: BorderSide(color: Config.COLOR_DARKGRAY))*/, fillColor: Colors.white, filled: true)))) : SizedBox.shrink(),
